Shader "Hidden/Locked/.poiyomi/Poiyomi Toon/31c019a5fcd06f94c8690b0a1c7654de"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			float4 frag(VertexOut i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				poiFragData.baseColor *= poiThemeColor(poiMods, float4(0,0,1,0.4666667).rgb, 0.0);
				poiFragData.alpha = mainTexture.a * float4(0,0,1,0.4666667).a;
				#else
