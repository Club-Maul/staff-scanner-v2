Shader "Hidden/Locked/.poiyomi/Poiyomi Toon/e73a3195f11bd1a4282c197de2cb3d6e"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			float4 frag(VertexOut i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				poiFragData.baseColor *= poiThemeColor(poiMods, float4(1,0,1,0.4666667).rgb, 0.0);
				poiFragData.alpha = mainTexture.a * float4(1,0,1,0.4666667).a;
				#else
