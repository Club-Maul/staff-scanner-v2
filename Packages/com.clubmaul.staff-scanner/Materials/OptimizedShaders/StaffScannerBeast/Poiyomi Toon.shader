Shader "Hidden/Locked/.poiyomi/Poiyomi Toon/b9cded208962127459c7733a36f932d8"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			float4 frag(VertexOut i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				poiFragData.baseColor *= poiThemeColor(poiMods, float4(1,0,0,0.4666667).rgb, 0.0);
				poiFragData.alpha = mainTexture.a * float4(1,0,0,0.4666667).a;
				#else
